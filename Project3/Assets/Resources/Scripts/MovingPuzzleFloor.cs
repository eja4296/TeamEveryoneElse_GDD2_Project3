...
public class MovingPuzzleFloor : Floor {
    ...
    public override int[,] GetEasyPuzzle()
    {
		...
		return new int[,] {
            {7, 6, 4, 1, 1, 1, 1, 1, 2, 3, 0, 0, 0, 0 },
			{7, 7, 7, 2, 1, 2, 1, 7, 3, 0, 0, 0, 0, 0 },
			{2, 2, 0, 1, 0, 1, 0, 7, 8, 0, 0, 0, 0, 0 },
			{2, 3, 0, 2, 3, 3, 3, 7, 7, 0, 0, 0, 0, 0 },
			{2, 8, 0, 7, 2, 1, 2, 8, 2, 0, 0, 0, 0, 0 },
			{2, 8, 0, 8, 2, 0, 1, 7, 1, 0, 0, 0, 0, 0 },
			{7, 2, 0, 2, 3, 0, 8, 2, 1, 0, 0, 0, 0, 0 },
			{7, 2, 0, 1, 1, 0, 8, 1, 7, 0, 0, 0, 0, 0 },
			{8, 1, 0, 7, 7, 7, 3, 2, 7, 0, 0, 0, 0, 0 },
			{8, 8, 0, 7, 5, 7, 0, 3, 8, 8, 0, 0, 0, 0 },
			{8, 8, 0, 7, 5, 7, 0, 3, 8, 8, 0, 0, 0, 0 },
			{8, 8, 0, 7, 5, 7, 0, 3, 8, 8, 0, 0, 0, 0 },
			{8, 8, 0, 7, 5, 7, 0, 3, 8, 8, 0, 0, 0, 0 },
			{8, 8, 0, 7, 5, 7, 0, 3, 8, 8, 0, 0, 0, 0 },
